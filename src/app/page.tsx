        ...
        <div className={style.container}>
          <div className={style.frame_title}>
            <div className={style.fram_title_item}>
              ...
              <a
                href="https://github.com/Cucumberchik"
                target="_blank">
                Cucumberchik
              </a>
            </div>
          ...
          <div className={style.wellcome_title}>
            <h1>
              Премиальная WEB-разработка <br /> IT-решений
            </h1>
            <p>
              Добро пожаловать в <span>Техническую лабораторию</span>{" "}
              веб-разработок
              <br />Я занимаемаюсь WEB-разработкой по новым технологиям для
              Ваших проектов.
            </p>
          </div>
